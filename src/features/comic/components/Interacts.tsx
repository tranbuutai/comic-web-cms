...
export const Interacts = ({ like, unlike, views, bookMark }: InteractType) => {
    return (
        <div className="w-full max-w-lg lg:max-w-sm xl:max-w-lg 2xl:max-w-lg h-108 shadow-base border border-gray-200 px-6 pt-2 rounded-2xl">
            ...
            <div className="grid grid-cols-2 grid-rows-2 h-4/6 gap-4">
                ...
                <div className="hover:shadow-base col-span-2 cursor-pointer transition-all duration-150 border border-gray-200 rounded-lg flex justify-center items-center shadow-sm">
                    <div className="text-center">
